...
<head>
    ...
    <body <?php body_class(); ?>>
      ...
      <header <?php if(is_tax() || is_post_type_archive('works') || !empty($disable) || is_singular('post') || basename(get_page_template()) == 'page-projects.php') echo 'class="short-header"'; ?>>

        <div class="position-absolute top-0 start-0 end-0 z-index-9 pt-3" id="top-bar">
            <div class="container">
                <div class="row">
