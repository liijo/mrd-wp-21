                  ...
                  <div class="row align-items-center flex-row-reverse">
                     ...
                     <div class="col-xl-7 col-md-7">
                        <div class="panel-heading">
                           <h3 class="section-title"><?php the_field('section_1_title__'); ?></h3>
                        ...
                        <div class="panel-btn">
                           <a  class="btn btn-primary rounded lpbtn"  data-toggle="modal" data-target="#mdServiceseochk" ><?php the_field('call_action_button_name'); ?> <span class="icon-right ps-2"></span></a>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="container-fluid container-xl">
                  <div class="row">
                     <div class="col-xl-10 mx-auto text-center">
                        <div class="panel-heading">
                           <h3 class="section-title"><?php the_field('section_2_title'); ?></h3>
            ...
            <section class="section-seo-page section-seo-three">
               <div class="container-fluid container-xl">
                  <div class="row">
                     <div class="col-12">
                        <div class="panel-heading">
                           <h3 class="section-title"><?php the_field('section_3_title'); ?></h3>
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="panel-heading text-center">
                           <h3 class="section-title"><?php the_field('section_4_title__'); ?></h3>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-10 mx-auto">
                        <div class="water-wheel-carousel-panel">
                           <div id="carrousel" class="water-wheel-carousel owl-carousel">
            ...
            <section class="section-seo-page section-seo-five">
               <div class="container-fluid container-xl">
                  <div class="row">
                     <div class="col-12">
                        <div class="panel-heading text-center">
                           <h3 class="section-title"><?php the_field('section_5_title'); ?></h3>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="modal-form-panel">
                      ...
                      <?php echo do_shortcode('[contact-form-7 id="'.$formopou.'" title="Seo check list LP"]') ;
                       //echo $formopou;
                      ?>
                    </div>
...
if ( '6788' == event.detail.contactFormId ) {
  ...
  // console.log(event.detail.inputs[2].value);
location = '<?php echo get_permalink( 6326 ); ?>?email=' + event.detail.inputs[2].value + '&yname=' + event.detail.inputs[0].value;
}
...
else if( '6717' == event.detail.contactFormId ){
