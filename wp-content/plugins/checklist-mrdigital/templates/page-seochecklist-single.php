<?php
/*
  Template Name: SEO Check List Service Page
  Template Post Type: mrd_landing_pages
 */
get_header('inner');
...
<?php if (have_posts()) : the_post(); ?>
      ...
      <div class="site-frame">
         ...
         <div id="page" class="site-page">
            ...
            <!-- ==================[ banner **]================== -->
           <?php $bannerbg=get_field('banner_image_lp'); ?>
            <section class="section-seo-page section-seo-banner" style="background: url(<?php echo $bannerbg['url']; ?>); background-size: cover;">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-xl-10 mx-auto">
                        <div class="panel-heading">
                           <h2><?php the_field('banner_title_seochklist'); ?></h2>
                           <p><?php the_field('banner_description__seochklist'); ?></p>
                        </div>
                        <div class="panel-btn">
               ...
               <a href="#firstSection" class="btn-scroll">
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-double-down" fill="currentColor" xmlns="https://www.w3.org/2000/svg">
                    ...
                    <div class="row">
                       <div class="col-12">
                          <div class="owl-carousel brand-carousel">
                            <?php
                           $New = new WP_Query(array('post_type' => 'clients', 'posts_per_page' => '-1',));
                            $i = 1;
                            while ($New->have_posts()) : $New->the_post();
                                    ?>
                             <div class="item"><div class="bc-panel"><?php the_post_thumbnail('full'); ?></div></div>
                            <?php endwhile; ?>
                     ...
                     <div class="col-xl-7 col-lg-9 col-md-10 mx-auto">
                        <div class="water-wheel-carousel-panel">
                           ...
                           <div class="arrow-panel">
                              <a href="#" id="prev" class="arrow-prev"><img src="<?php echo get_template_directory_uri(); ?>/imglp/arrow-prev.svg" alt="icon"></a>
                              <a href="#" id="next" class="arrow-next"><img src="<?php echo get_template_directory_uri(); ?>/imglp/arrow-next.svg" alt="icon"></a>
                           </div>
                        </div>
                     </div>
                  </div>
...
location = 'https://www.mr-digital.co.uk/thank-you-seo-check-list/';
}
//LinkedIn Prospecting Checklist form
else if( '4213' == event.detail.contactFormId ){
location = 'https://www.mr-digital.co.uk/thank-you-linkedin-prospecting-checklist/';
}
//Ideal Customer Checklist form
else if( '4249' == event.detail.contactFormId ){
location = 'https://www.mr-digital.co.uk/thank-you-ideal-customer-checklist/';
}
//Landing Page Optimisation Checklist
else if( '4250' == event.detail.contactFormId ){
location = 'https://www.mr-digital.co.uk/thank-you-landing-page-optimisation-checklist/';
}
//Facebook Ads Checklist form
else if( '4251' == event.detail.contactFormId ){
location = 'https://www.mr-digital.co.uk/thank-you-facebook-ads-checklist/';
}
}, false );
});
</script>
